...
#include "ZekaEngine/OpenGL/IncludeOpenGLHeaders.h"
...
public:
  ...
  void OnInitialize() override
  {
    Application::OnInitialize();
     ...
     pdesc.VertexShader = Zeka::Engine::Get()->GetRenderDevice()->CreateShader(R"(
 #version 300 es
 ...
 void main() { gl_Position = vec4(pos, 0.0, 1.0); }
     ...
     pdesc.FragmentShader = Zeka::Engine::Get()->GetRenderDevice()->CreateShader(R"(
 #version 300 es
